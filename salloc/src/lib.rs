...
#[unsafe(no_mangle)]
#[cfg(windows)]
pub unsafe extern "C" fn aligned_realloc(ptr: *mut c_void, _old: usize, size: usize, align: usize) -> *mut c_void {
  unsafe {
...
#[unsafe(no_mangle)]
#[cfg(not(windows))]
pub unsafe extern "C" fn aligned_realloc(ptr: *mut c_void, old: usize, size: usize, align: usize) -> *mut c_void {
  unsafe {
    if ptr.is_null() {
