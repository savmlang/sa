...
use crate::acaot::{
  ...
  pickle::def::{
    ...
    PICKLE_OPCODE_REM, PICKLE_OPCODE_SCRATCH, PICKLE_OPCODE_SYNCCALL, PICKLE_OPCODE_VABS,
    PICKLE_OPCODE_VADD, PICKLE_OPCODE_VADDF, PICKLE_OPCODE_VBIT, PICKLE_OPCODE_VCMP,
    PICKLE_OPCODE_VCNT, PICKLE_OPCODE_VCOPY, PICKLE_OPCODE_VDIVF, PICKLE_OPCODE_VFCAST,
    PICKLE_OPCODE_VFMA, PICKLE_OPCODE_VFOP, PICKLE_OPCODE_VMINIMAX, PICKLE_OPCODE_VMUL,
    PICKLE_OPCODE_VMULF, PICKLE_OPCODE_VNEG, PICKLE_OPCODE_VROT, PICKLE_OPCODE_VSH,
    PICKLE_OPCODE_VSUB, PICKLE_OPCODE_VSUBF, PICKLE_OPCODE_WS_PUT, PickleInstruction,
  },
};
use cranelift::{
  frontend::Switch,
